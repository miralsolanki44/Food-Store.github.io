...
Route::get('/aboutus', 'lbmController@aboutus')->name('user.aboutus');
Route::get('/contact', 'lbmController@contact')->name('user.contact');
Route::get('/product', 'lbmController@product')->name('user.product');
